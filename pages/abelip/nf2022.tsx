...
const Index = () => {
    return (
        <div>
            ...
            <main>
                <HeadContainer>
                    <HeadImageContainer><Image src="/imgs/nf2022/xH-026.png" fill alt="" /></HeadImageContainer>
                    <HeadInfoContainer>
                ...
                <Abstraction>
                    <p>ご存じアイル共和国の架空伝統ゲーム、「机戦」がNFに初上陸！<br />
                    机戦にまつわるさまざまな史料・動画・背景などを紹介します！<br />
                    すべての画像にリンクが張られているのでぜひジャンプしてみてください！</p>
                </Abstraction>
                ...
                <section>
                    ...
                    <Subsection>
                        ...
                        <SubsectionContent>
                            ...
                            <SubsectionImageContainer>
                                <IframeContainer><iframe src="https://www.youtube.com/embed/l1oRqKTQ0s8" title="YouTube video player" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe></IframeContainer>
                            </SubsectionImageContainer>
                        </SubsectionContent>
                    </Subsection>
                    ...
                    <Subsection>
                        ...
                        <SubsectionContent>
                            ...
                            <SubsectionInfo>
                                <p>好評発売中！</p>
                                <p>実はNFの企画でも出店しています。お住まいの地域によってはNFで買った方が得になります。</p>
                            </SubsectionInfo>
                        </SubsectionContent>
                    </Subsection>
                    ...
                    <Subsection>
                        ...
                        <SubsectionContent>
                            <SubsectionInfo>
                                <p>私たちのDiscordサーバーへどうぞ！高頻度で雑談通話や作業通話が行われているにぎやかなサーバーです！</p>
                                <p>アカウントを持っていなくてもメールアドレスから簡単に作れますよ！</p>
                            </SubsectionInfo>
                            <SubsectionImageContainer>
                ...
                <section>
                    ...
                    <Subsection>
                        ...
                        <SubsectionContent>
                            ...
                            <SubsectionInfo>
                                ...
                                <p>ちなみに左の地図の濃い破線は鉄道で、郡境は薄い破線です。北は下側で、東が右です。</p>
                            </SubsectionInfo>
                        </SubsectionContent>
                    </Subsection>
                    ...
                    <Subsection>
                        ...
                        <SubsectionContent>
                            <SubsectionInfo>
                                    <p>平面的に裁断された綿布で作った上着を着てズボンをはいた、作務衣に似た衣服が民族衣装として知られています。</p>
                                    <p>写真の料理はペースーと呼ばれるきのこスープに米飯を添えたものです。アイルでは米が主食に好まれ、お酒も盛んに飲まれています。</p>
                                    <p>画像中の絵はアイルの首都マカティの街並みを描いたもので、木造建築が多く立ち並んでいるのがわかります。</p>
                                    <p>皇論（タムツイ）と呼ばれるアニミズム宗教が信じられており、法の精神や税制の方針といった国家の運営方針にも影響しています。</p>
                            </SubsectionInfo>
                            <SubsectionImageContainer>
                    ...
                    <Subsection>
                        ...
                        <SubsectionContent>
                            ...
                            <SubsectionInfo>
                                ...
                                <p>右のポスターはアイルの北西部に位置するイヌシ郡で行われた机戦の大会について宣伝しているもので、午前に机戦を遊び、午後に四人机戦とプロプレイヤーによる解説講演が行われると書かれています。</p>
                            </SubsectionInfo>
                        </SubsectionContent>
                    </Subsection>
                ...
                <section>
                    ...
                    <Subsection>
                        ...
                        <SubsectionContent>
                            ...
                            <SubsectionInfo>
                                ...
                                <p>アイル、ヴェフィス、リナエストの3か国はどれも隣接した島嶼部に建てられており、モンスターからの防衛や食料問題の解決のためPMCF（東諸島共和国連合）という連合を作り互いに助けあっています。</p>
                            </SubsectionInfo>
                        </SubsectionContent>
                    </Subsection>
                    ...
                    <Subsection>
                        ...
                        <SubsectionContent>
                            <SubsectionInfo>
                                <p>アイル、ヴェフィス、リナエストは公用語が大きく異なっており、PMCFでは意思疎通のために公用語として東島通商語という言語が定められています。これはこの世界におけるリングア・フランカ（覇権言語）であるリパライン語がアイル語、パイグ語、ヴェフィス語など様々な言語との接触を経て出来上がったクレオール言語です。発音が比較的単純なことで知られ、修飾のために「LETI」という単語が頻用されるという特徴を持ちます。</p>
                                <p>これまでさんざん画像に登場している謎の言語は、実はこれです。</p>
                                <p>右は、アイル文化省が制作した机戦の文化に関するドキュメンタリーのオープニングです。</p>
                            </SubsectionInfo>
                            <SubsectionImageContainer>
                                <IframeContainer><iframe src="https://www.youtube.com/embed/y6m7JKlEUsA" title="YouTube video player" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe></IframeContainer>
                            </SubsectionImageContainer>
                        </SubsectionContent>
                    </Subsection>
                    ...
                    <Subsection>
                        ...
                        <SubsectionContent>
                            <SubsectionImageContainer>
                                <IframeContainer><iframe src="https://www.youtube.com/embed/3WYTi2Yp54Q" title="YouTube video player" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe></IframeContainer>
                            </SubsectionImageContainer>
                            <SubsectionInfo>
                                <p>この世界においてリパライン語の属するリパラオネ語族と対をなしているラネーメ語族に属する言語で、多くの単語が単音節からなり、かつ声調を持っているという少し中国語に似た特徴を持ちます。</p>
                                <p>机戦はもともとパイグ民族の遊戯であったとされ、机戦における用語や宣言などの多くはパイグ語が元になって各言語へ輸入されています。</p>
                                <p>左は、全編通してパイグ語を使いながら机戦を遊んでいる動画です。</p>
                            </SubsectionInfo>
                        </SubsectionContent>
                    </Subsection>
                    ...
                    <Subsection>
                        ...
                        <SubsectionContent>
                            <SubsectionInfo>
                                <p>この世界で7000年以上前から使われる表語文字です。こちらの世界の漢字に相当する字で、ほとんどの言語がこれによって表記される時期を経験しているという非常に伝統のある文字です。漢字はその多くが形声文字なのに対して、燐字は会意による造字をこのむ傾向にあります。</p>
                                <p>画像は、アイルの文化省が机戦の統一ルールを作るにあたって発行した文書の写本です。</p>
                            </SubsectionInfo>
                            <SubsectionImageContainer>
